...
namespace CqrsSample.Inventory.CommandStack.Infrastructure
{
  ...
  public interface IEventStore
  {
    ...
    /// This is used in order to perform the optimistic concurrency check before appending the new events to the event stream.
    /// This parameter is expected to be a non negative integer. Pass the value zero (0) when you are creating a fresh new event stream.
    /// </param>
